...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/orderedmap/index.es.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/prosemirror-model/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
},{"orderedmap":"node_modules/orderedmap/index.es.js"}],"node_modules/prosemirror-transform/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
},{"prosemirror-model":"node_modules/prosemirror-model/dist/index.es.js"}],"node_modules/prosemirror-state/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
},{"prosemirror-model":"node_modules/prosemirror-model/dist/index.es.js","prosemirror-transform":"node_modules/prosemirror-transform/dist/index.es.js"}],"node_modules/prosemirror-view/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
var MouseDown = function MouseDown(view, pos, event, flushed) {
  ...
  if (targetNode.type.spec.draggable && targetNode.type.spec.selectable !== false || view.state.selection instanceof _prosemirrorState.NodeSelection && targetPos == view.state.selection.from) {
    this.mightDrag = {
      node: targetNode,
      pos: targetPos,
...
MouseDown.prototype.up = function up(event) {
  ...
  // works around that.
  result.chrome && !(this.view.state.selection instanceof _prosemirrorState.TextSelection) && (pos.pos == this.view.state.selection.from || pos.pos == this.view.state.selection.to)) {
...
},{"prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js","prosemirror-model":"node_modules/prosemirror-model/dist/index.es.js","prosemirror-transform":"node_modules/prosemirror-transform/dist/index.es.js"}],"node_modules/w3c-keyname/index.es.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/prosemirror-keymap/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
},{"w3c-keyname":"node_modules/w3c-keyname/index.es.js","prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js"}],"node_modules/prosemirror-inputrules/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
},{"prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js","prosemirror-transform":"node_modules/prosemirror-transform/dist/index.es.js"}],"node_modules/prosemirror-commands/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
},{"prosemirror-transform":"node_modules/prosemirror-transform/dist/index.es.js","prosemirror-model":"node_modules/prosemirror-model/dist/index.es.js","prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js"}],"node_modules/prosemirror-schema-list/dist/index.es.js":[function(require,module,exports) {
"use strict";
  ...
  return function (state, dispatch) {
    ...
    if ($from.parent.content.size == 0 && $from.node(-1).childCount == $from.indexAfter(-1)) {
      ...
      if (dispatch) {
        ...
        var tr$1 = state.tr.replace($from.before(keepItem ? null : -1), $from.after(-3), new _prosemirrorModel.Slice(wrap, keepItem ? 3 : 2, 2));
...
},{"prosemirror-transform":"node_modules/prosemirror-transform/dist/index.es.js","prosemirror-model":"node_modules/prosemirror-model/dist/index.es.js"}],"node_modules/@tiptap/core/dist/tiptap-core.esm.js":[function(require,module,exports) {
"use strict";
...
exports.extensions = exports.NodeView = exports.Node = exports.Mark = exports.Extension = exports.Editor = void 0;
...
function isMarkActive(state, typeOrName, attributes = {}) {
  ...
  const range = markRanges.filter(markRange => {
    if (!type) {
      return true;
    }
...
function createNodeFromContent(content, schema, options) {
  ...
  if (typeof content === 'string') {
    ...
    if (isHTML || !options.slice) {
      const parser = _prosemirrorModel.DOMParser.fromSchema(schema);
...
function getHTMLFromFragment(doc, schema) {
  const fragment = _prosemirrorModel.DOMSerializer.fromSchema(schema).serializeFragment(doc.content);
...
function createExtensionContext(extension, data) {
  const context = { ...data,
...
function getSchema(extensions) {
  ...
  const nodes = Object.fromEntries(nodeExtensions.map(extension => {
    ...
    if (extension.config.parseHTML) {
      schema.parseDOM = (_a = extension.config.parseHTML.bind(context)()) === null || _a === void 0 ? void 0 : _a.map(parseRule => injectExtensionAttributesToParseRule(parseRule, extensionAttributes));
    }
...
class ExtensionManager {
  ...
  get plugins() {
    return [...this.extensions].reverse().map(extension => {
      ...
      if (extension.config.addKeyboardShortcuts) {
        const keyMapPlugin = (0, _prosemirrorKeymap.keymap)(extension.config.addKeyboardShortcuts.bind(context)());
      ...
      if (this.editor.options.enableInputRules && extension.config.addInputRules) {
        ...
        const inputRulePlugins = inputRules$1.length ? [(0, _prosemirrorInputrules.inputRules)({
          rules: inputRules$1
        })] : [];
  ...
  get nodeViews() {
    ...
    return Object.fromEntries(nodeExtensions.filter(extension => !!extension.config.addNodeView).map(extension => {
      var _a;
  ...
  get textSerializers() {
    ...
    return Object.fromEntries(nodeExtensions.filter(extension => !!extension.config.renderText).map(extension => {
      const context = createExtensionContext(extension, {
        options: extension.options,
        editor,
        type: getNodeType(extension.config.name, this.schema)
      ...
      const textSerializer = props => {
        var _a;

        return (_a = extension.config.renderText) === null || _a === void 0 ? void 0 : _a.call(context, props);
      };
...
class Extension {
  ...
  configure(options = {}) {
    ...
    return __classPrivateFieldGet(_a = Extension.create(this.config), _configure$2).call(_a, options);
  }
...
const deleteSelection = () => ({
  ...
  return (0, _prosemirrorCommands.deleteSelection)(state, dispatch);
};
...
const exitCode = () => ({
  ...
  return (0, _prosemirrorCommands.exitCode)(state, dispatch);
};
...
const extendMarkRange = typeOrName => ({
  tr,
  state,
  dispatch
}) => {
  ...
  if (empty && dispatch) {
    ...
    if (range) {
      const newSelection = _prosemirrorState.TextSelection.create(doc, range.from, range.to);
...
function isTextSelection(value) {
  return isObject(value) && value instanceof _prosemirrorState.TextSelection;
}
...
const focus = (position = null) => ({
  ...
  const selection = _prosemirrorState.TextSelection.create(doc, resolvedFrom, resolvedEnd);
...
function selectionToInsertionEnd(tr, startLen, bias) {
  ...
  tr.setSelection(_prosemirrorState.Selection.near(tr.doc.resolve(end), bias));
}
...
const insertHTML = value => ({
  ...
  const slice = _prosemirrorModel.DOMParser.fromSchema(state.schema).parseSlice(element);
...
const insertNode = (typeOrName, attributes = {}) => ({
  tr,
  state,
  dispatch
}) => {
...
const joinBackward = () => ({
  ...
  return (0, _prosemirrorCommands.joinBackward)(state, dispatch);
};
...
const joinForward = () => ({
  ...
  return (0, _prosemirrorCommands.joinForward)(state, dispatch);
};
...
const liftEmptyBlock = () => ({
  ...
  return (0, _prosemirrorCommands.liftEmptyBlock)(state, dispatch);
};
...
const liftListItem = typeOrName => ({
  ...
  const type = getNodeType(typeOrName, state.schema);
  return (0, _prosemirrorSchemaList.liftListItem)(type)(state, dispatch);
};
...
const newlineInCode = () => ({
  ...
  return (0, _prosemirrorCommands.newlineInCode)(state, dispatch);
};
...
const resetNodeAttributes = (typeOrName, attributes) => ({
  tr,
  state,
  dispatch
}) => {
...
const selectAll = () => ({
  ...
  return (0, _prosemirrorCommands.selectAll)(state, dispatch);
};
...
const selectNodeBackward = () => ({
  ...
  return (0, _prosemirrorCommands.selectNodeBackward)(state, dispatch);
};
...
const selectNodeForward = () => ({
  ...
  return (0, _prosemirrorCommands.selectNodeForward)(state, dispatch);
};
...
const selectParentNode = () => ({
  ...
  return (0, _prosemirrorCommands.selectParentNode)(state, dispatch);
};
...
const setNode = (typeOrName, attributes = {}) => ({
  ...
  const type = getNodeType(typeOrName, state.schema);
  return (0, _prosemirrorCommands.setBlockType)(type, attributes)(state, dispatch);
};
...
const sinkListItem = typeOrName => ({
  ...
  const type = getNodeType(typeOrName, state.schema);
  return (0, _prosemirrorSchemaList.sinkListItem)(type)(state, dispatch);
};
...
const splitBlock = ({
  ...
  if (selection instanceof _prosemirrorState.NodeSelection && selection.node.isBlock) {
    if (!$from.parentOffset || !(0, _prosemirrorTransform.canSplit)(doc, $from.pos)) {
      return false;
    }
  ...
  if (dispatch) {
    ...
    if (can) {
      ...
      if (!atEnd && !$from.parentOffset && $from.parent.type !== deflt && $from.node(-1).canReplace($from.index(-1), $from.indexAfter(-1), _prosemirrorModel.Fragment.from(deflt === null || deflt === void 0 ? void 0 : deflt.create()))) {
...
const splitListItem = typeOrName => ({
  ...
  if ($from.parent.content.size === 0 && $from.node(-1).childCount === $from.indexAfter(-1)) {
    ...
    if (dispatch) {
      ...
      wrap = wrap.append(_prosemirrorModel.Fragment.from(type.createAndFill(null, nextType) || undefined));
      tr.replace($from.before(keepItem ? undefined : -1), $from.after(-3), new _prosemirrorModel.Slice(wrap, keepItem ? 3 : 2, 2)).setSelection(_prosemirrorState.TextSelection.near(tr.doc.resolve($from.pos + (keepItem ? 3 : 2)))).scrollIntoView();
    }
  ...
  if (!(0, _prosemirrorTransform.canSplit)(tr.doc, $from.pos, 2)) {
    return false;
  }
...
function isList(name, extensions) {
  ...
  const groups = callOrReturn(extension.config.group, {
    options: extension.options
  });
...
const toggleWrap = (typeOrName, attributes = {}) => ({
  ...
  return (0, _prosemirrorCommands.wrapIn)(type, attributes)(state, dispatch);
};
...
const undoInputRule = () => ({
  ...
  return (0, _prosemirrorInputrules.undoInputRule)(state, dispatch);
};
    ...
    tr.selection.ranges.forEach(range => {
      state.doc.nodesBetween(range.$from.pos, range.$to.pos, (node, pos) => {
        ...
        if (markType && node.marks.length) {
          node.marks.forEach(mark => {
            if (markType === mark.type) {
              tr.addMark(pos, pos + node.nodeSize, markType.create({ ...mark.attrs,
                ...attributes
              }));
            }
          });
...
const updateNodeAttributes = (typeOrName, attributes = {}) => ({
  tr,
  state,
  dispatch
}) => {
...
const wrapInList = (typeOrName, attributes = {}) => ({
  ...
  const type = getNodeType(typeOrName, state.schema);
  return (0, _prosemirrorSchemaList.wrapInList)(type, attributes)(state, dispatch);
};
...
const FocusEvents = Extension.create({
  ...
  addProseMirrorPlugins() {
    ...
    return [new _prosemirrorState.Plugin({
      key: new _prosemirrorState.PluginKey('focusEvents'),
      props: {
        attributes: {
          tabindex: '0'
        },
...
const Keymap = Extension.create({
  ...
  addKeyboardShortcuts() {
    ...
    return {
      ...
      Delete: () => handleDelete(),
      'Mod-Delete': () => handleDelete() // we don’t need a custom `selectAll` for now
...
class Editor extends EventEmitter {
  ...
  createView() {
    this.view = new _prosemirrorView.EditorView(this.options.element, { ...this.options.editorProps,
...
class Node {
  ...
  configure(options = {}) {
    ...
    return __classPrivateFieldGet(_a = Node.create(this.config), _configure$1).call(_a, options);
  }

  extend(extendedConfig) {
    const extension = new Node({ ...this.config,
      ...extendedConfig
    });
    extension.parentConfig = this.config;
    return extension;
...
class Mark {
  ...
  configure(options = {}) {
    ...
    return __classPrivateFieldGet(_a = Mark.create(this.config), _configure).call(_a, options);
  }

  extend(extendedConfig) {
    const extension = new Mark({ ...this.config,
      ...extendedConfig
    });
    extension.parentConfig = this.config;
    return extension;
...
class NodeView {
  ...
  onDragStart(event) {
    ...
    const y = handleBox.y - domBox.y + event.offsetY; // sometimes `event.target` is not the `dom` element

    (_b = event.dataTransfer) === null || _b === void 0 ? void 0 : _b.setDragImage(this.dom, x, y);

    const selection = _prosemirrorState.NodeSelection.create(view.state.doc, this.getPos());
  ...
  stopEvent(event) {
    ...
    const isSelectable = _prosemirrorState.NodeSelection.isSelectable(this.node);
  ...
  ignoreMutation(mutation) {
    ...
    const contentDOMHasChanged = !this.contentDOM.contains(mutation.target) || this.contentDOM === mutation.target && mutation.type === 'attributes';
...
function markPasteRule(regexp, type, getAttrs) {
  ...
  return new _prosemirrorState.Plugin({
    key: new _prosemirrorState.PluginKey('markPasteRule'),
    props: {
...
function generateHTML(doc, extensions) {
  ...
  const contentNode = _prosemirrorModel.Node.fromJSON(schema, doc);

  return getHTMLFromFragment(contentNode, schema);
}

function isNodeSelection(value) {
  return isObject(value) && value instanceof _prosemirrorState.NodeSelection;
}
},{"prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js","prosemirror-view":"node_modules/prosemirror-view/dist/index.es.js","prosemirror-model":"node_modules/prosemirror-model/dist/index.es.js","prosemirror-keymap":"node_modules/prosemirror-keymap/dist/index.es.js","prosemirror-inputrules":"node_modules/prosemirror-inputrules/dist/index.es.js","prosemirror-transform":"node_modules/prosemirror-transform/dist/index.es.js","prosemirror-commands":"node_modules/prosemirror-commands/dist/index.es.js","prosemirror-schema-list":"node_modules/prosemirror-schema-list/dist/index.es.js"}],"node_modules/prosemirror-dropcursor/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
},{"prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js","prosemirror-transform":"node_modules/prosemirror-transform/dist/index.es.js"}],"node_modules/@tiptap/extension-dropcursor/dist/tiptap-extension-dropcursor.esm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Dropcursor = exports.default = void 0;
...
const Dropcursor = _core.Extension.create({
  ...
  addProseMirrorPlugins() {
    return [(0, _prosemirrorDropcursor.dropCursor)(this.options)];
  }

});

exports.Dropcursor = Dropcursor;
var _default = Dropcursor;
exports.default = _default;
},{"@tiptap/core":"node_modules/@tiptap/core/dist/tiptap-core.esm.js","prosemirror-dropcursor":"node_modules/prosemirror-dropcursor/dist/index.es.js"}],"node_modules/prosemirror-gapcursor/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
},{"prosemirror-keymap":"node_modules/prosemirror-keymap/dist/index.es.js","prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js","prosemirror-view":"node_modules/prosemirror-view/dist/index.es.js","prosemirror-model":"node_modules/prosemirror-model/dist/index.es.js"}],"node_modules/@tiptap/extension-gapcursor/dist/tiptap-extension-gapcursor.esm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Gapcursor = exports.default = void 0;
...
const Gapcursor = _core.Extension.create({
  ...
  addProseMirrorPlugins() {
    return [(0, _prosemirrorGapcursor.gapCursor)()];
  },

  extendNodeSchema(extension) {
    var _a;

    const context = (0, _core.createExtensionContext)(extension, {
      options: extension.options
    });
    return {
      allowGapCursor: (_a = (0, _core.callOrReturn)(extension.config.allowGapCursor, context)) !== null && _a !== void 0 ? _a : null
    };
  }
...
exports.Gapcursor = Gapcursor;
var _default = Gapcursor;
exports.default = _default;
},{"@tiptap/core":"node_modules/@tiptap/core/dist/tiptap-core.esm.js","prosemirror-gapcursor":"node_modules/prosemirror-gapcursor/dist/index.es.js"}],"node_modules/@tiptap/extension-document/dist/tiptap-extension-document.esm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Document = exports.default = void 0;
...
exports.default = _default;
},{"@tiptap/core":"node_modules/@tiptap/core/dist/tiptap-core.esm.js"}],"node_modules/@tiptap/extension-paragraph/dist/tiptap-extension-paragraph.esm.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"@tiptap/core":"node_modules/@tiptap/core/dist/tiptap-core.esm.js"}],"node_modules/@tiptap/extension-text/dist/tiptap-extension-text.esm.js":[function(require,module,exports) {
"use strict";
...
var _default = Text;
exports.default = _default;
},{"@tiptap/core":"node_modules/@tiptap/core/dist/tiptap-core.esm.js"}],"node_modules/rope-sequence/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"node_modules/prosemirror-history/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
},{"rope-sequence":"node_modules/rope-sequence/dist/index.es.js","prosemirror-transform":"node_modules/prosemirror-transform/dist/index.es.js","prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js"}],"node_modules/@tiptap/extension-history/dist/tiptap-extension-history.esm.js":[function(require,module,exports) {
"use strict";
...
const History = _core.Extension.create({
  ...
  addProseMirrorPlugins() {
    return [(0, _prosemirrorHistory.history)(this.options)];
  },
...
exports.default = _default;
},{"@tiptap/core":"node_modules/@tiptap/core/dist/tiptap-core.esm.js","prosemirror-history":"node_modules/prosemirror-history/dist/index.es.js"}],"node_modules/@tiptap/extension-bold/dist/tiptap-extension-bold.esm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.underscorePasteRegex = exports.underscoreInputRegex = exports.starPasteRegex = exports.starInputRegex = exports.Bold = exports.default = void 0;
...
const Bold = _core.Mark.create({
  ...
  addInputRules() {
    return [(0, _core.markInputRule)(starInputRegex, this.type), (0, _core.markInputRule)(underscoreInputRegex, this.type)];
  },

  addPasteRules() {
    return [(0, _core.markPasteRule)(starPasteRegex, this.type), (0, _core.markPasteRule)(underscorePasteRegex, this.type)];
  }
...
var _default = Bold;
exports.default = _default;
},{"@tiptap/core":"node_modules/@tiptap/core/dist/tiptap-core.esm.js"}],"node_modules/@tiptap/extension-italic/dist/tiptap-extension-italic.esm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.underscorePasteRegex = exports.underscoreInputRegex = exports.starPasteRegex = exports.starInputRegex = exports.Italic = exports.default = void 0;
...
var _default = Italic;
exports.default = _default;
},{"@tiptap/core":"node_modules/@tiptap/core/dist/tiptap-core.esm.js"}],"node_modules/@tiptap/extension-code/dist/tiptap-extension-code.esm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.pasteRegex = exports.inputRegex = exports.Code = exports.default = void 0;
...
const Code = _core.Mark.create({
  ...
  addInputRules() {
    return [(0, _core.markInputRule)(inputRegex, this.type)];
  },

  addPasteRules() {
    return [(0, _core.markPasteRule)(inputRegex, this.type)];
  }
...
var _default = Code;
exports.default = _default;
},{"@tiptap/core":"node_modules/@tiptap/core/dist/tiptap-core.esm.js"}],"node_modules/@tiptap/extension-code-block/dist/tiptap-extension-code-block.esm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.tildeInputRegex = exports.backtickInputRegex = exports.CodeBlock = exports.default = void 0;
...
const CodeBlock = _core.Node.create({
  ...
  addInputRules() {
    return [(0, _prosemirrorInputrules.textblockTypeInputRule)(backtickInputRegex, this.type, ({
      groups
    }) => groups), (0, _prosemirrorInputrules.textblockTypeInputRule)(tildeInputRegex, this.type, ({
      groups
    }) => groups)];
  }
...
exports.default = _default;
},{"@tiptap/core":"node_modules/@tiptap/core/dist/tiptap-core.esm.js","prosemirror-inputrules":"node_modules/prosemirror-inputrules/dist/index.es.js"}],"node_modules/@tiptap/extension-heading/dist/tiptap-extension-heading.esm.js":[function(require,module,exports) {
"use strict";
...
const Heading = _core.Node.create({
  ...
  addInputRules() {
    return this.options.levels.map(level => {
      return (0, _prosemirrorInputrules.textblockTypeInputRule)(new RegExp(`^(#{1,${level}})\\s$`), this.type, {
        level
      });
    });
  }
...
exports.default = _default;
},{"@tiptap/core":"node_modules/@tiptap/core/dist/tiptap-core.esm.js","prosemirror-inputrules":"node_modules/prosemirror-inputrules/dist/index.es.js"}],"node_modules/@tiptap/extension-hard-break/dist/tiptap-extension-hard-break.esm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.HardBreak = exports.default = void 0;
  ...
  addCommands() {
    return {
      setHardBreak: () => ({
        ...
        return commands.first([() => (0, _prosemirrorCommands.exitCode)(state, dispatch), () => {
          if (dispatch) {
...
exports.default = _default;
},{"@tiptap/core":"node_modules/@tiptap/core/dist/tiptap-core.esm.js","prosemirror-commands":"node_modules/prosemirror-commands/dist/index.es.js"}],"node_modules/@tiptap/extension-strike/dist/tiptap-extension-strike.esm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.pasteRegex = exports.inputRegex = exports.Strike = exports.default = void 0;
...
var _default = Strike;
exports.default = _default;
},{"@tiptap/core":"node_modules/@tiptap/core/dist/tiptap-core.esm.js"}],"node_modules/@tiptap/extension-blockquote/dist/tiptap-extension-blockquote.esm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.inputRegex = exports.Blockquote = exports.default = void 0;
...
const Blockquote = _core.Node.create({
  ...
  addInputRules() {
    return [(0, _prosemirrorInputrules.wrappingInputRule)(inputRegex, this.type)];
  }
...
exports.default = _default;
},{"@tiptap/core":"node_modules/@tiptap/core/dist/tiptap-core.esm.js","prosemirror-inputrules":"node_modules/prosemirror-inputrules/dist/index.es.js"}],"node_modules/@tiptap/extension-horizontal-rule/dist/tiptap-extension-horizontal-rule.esm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.HorizontalRule = exports.default = void 0;
...
const HorizontalRule = _core.Node.create({
        ...
        if (dispatch) {
          ...
          if (!nodeAfter) {
            ...
            if (node) {
              ...
              tr.setSelection(_prosemirrorState.TextSelection.create(tr.doc, posAfter));
            }
          }
  ...
  addInputRules() {
    return [(0, _core.nodeInputRule)(/^(?:---|___\s|\*\*\*\s)$/, this.type)];
  }
...
exports.default = _default;
},{"@tiptap/core":"node_modules/@tiptap/core/dist/tiptap-core.esm.js","prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js"}],"node_modules/@tiptap/extension-bullet-list/dist/tiptap-extension-bullet-list.esm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.inputRegex = exports.BulletList = exports.default = void 0;
...
exports.default = _default;
},{"@tiptap/core":"node_modules/@tiptap/core/dist/tiptap-core.esm.js","prosemirror-inputrules":"node_modules/prosemirror-inputrules/dist/index.es.js"}],"node_modules/@tiptap/extension-ordered-list/dist/tiptap-extension-ordered-list.esm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.inputRegex = exports.OrderedList = exports.default = void 0;
...
const OrderedList = _core.Node.create({
  ...
  addInputRules() {
    return [(0, _prosemirrorInputrules.wrappingInputRule)(inputRegex, this.type, match => ({
      order: +match[1]
...
exports.default = _default;
},{"@tiptap/core":"node_modules/@tiptap/core/dist/tiptap-core.esm.js","prosemirror-inputrules":"node_modules/prosemirror-inputrules/dist/index.es.js"}],"node_modules/@tiptap/extension-list-item/dist/tiptap-extension-list-item.esm.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"@tiptap/core":"node_modules/@tiptap/core/dist/tiptap-core.esm.js"}],"node_modules/@tiptap/starter-kit/dist/tiptap-starter-kit.esm.js":[function(require,module,exports) {
"use strict";
...
var _extensionGapcursor = _interopRequireDefault(require("@tiptap/extension-gapcursor"));
...
var _extensionCodeBlock = _interopRequireDefault(require("@tiptap/extension-code-block"));
...
function defaultExtensions(options) {
  return [_extensionDocument.default, _extensionParagraph.default.configure(options === null || options === void 0 ? void 0 : options.paragraph), _extensionText.default, _extensionBold.default.configure(options === null || options === void 0 ? void 0 : options.bold), _extensionItalic.default.configure(options === null || options === void 0 ? void 0 : options.italic), _extensionCode.default.configure(options === null || options === void 0 ? void 0 : options.code), _extensionStrike.default.configure(options === null || options === void 0 ? void 0 : options.strike), _extensionHardBreak.default.configure(options === null || options === void 0 ? void 0 : options.hardBreak), _extensionHeading.default.configure(options === null || options === void 0 ? void 0 : options.heading), _extensionBlockquote.default.configure(options === null || options === void 0 ? void 0 : options.blockquote), _extensionBulletList.default.configure(options === null || options === void 0 ? void 0 : options.bulletList), _extensionOrderedList.default.configure(options === null || options === void 0 ? void 0 : options.orderedList), _extensionListItem.default.configure(options === null || options === void 0 ? void 0 : options.listItem), _extensionHorizontalRule.default.configure(options === null || options === void 0 ? void 0 : options.horizontalRule), _extensionCodeBlock.default.configure(options === null || options === void 0 ? void 0 : options.codeBlock), _extensionHistory.default.configure(options === null || options === void 0 ? void 0 : options.history), _extensionDropcursor.default.configure(options === null || options === void 0 ? void 0 : options.dropcursor), _extensionGapcursor.default];
}
